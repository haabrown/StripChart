function [ updated, binary, data ] = GetData(i)
    ...
    temps = [ThermBatt(hex2dec(ibinary(54:55)')),ThermBatt(hex2dec(ibinary(56:57)')),ThermSolar(binary(60)),ThermSolar(binary(58)),ThermSolar(binary(59)),TMP100(binary(64)),TMP100(binary(65)),TMP100(binary(41)),TMP100(binary(74))];
